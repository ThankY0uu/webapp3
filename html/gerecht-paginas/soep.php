...
$sql = "SELECT gerechten.naam, gerechten.prijs 
        ...
        WHERE gerechtsoorten.naam = 'soep-gerechten'
...
<input type="text" id="searchInput" placeholder="Zoek Soep..." class="search-menu-input" aria-label="Zoek Soep op naam">
...
<?php else: ?>
    <p>Er staan momenteel geen soepgerechten op het menu.</p>
<?php endif; ?>
