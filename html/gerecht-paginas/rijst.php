...
$sql = "SELECT gerechten.naam, gerechten.prijs 
        ...
        WHERE gerechtsoorten.naam = 'rijst-gerechten'
...
?>
    ...
    <input type="text" id="searchInput" placeholder="Zoek rijstgerecht..." class="search-menu-input" aria-label="Zoek rijstgerecht op naam">
    ...
    <?php else: ?>
        <p>Er staan momenteel geen rijstgerechten op het menu.</p>
    <?php endif; ?>

    <header><?php require_once("../components/footer.php") ?></header>
