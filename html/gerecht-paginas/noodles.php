...
$sql = "SELECT gerechten.naam, gerechten.prijs 
        ...
        WHERE gerechtsoorten.naam = 'noodle-gerechten'
...
<input type="text" id="searchInput" placeholder="Zoek noodles..." class="search-menu-input" aria-label="Zoek noodles op naam">
